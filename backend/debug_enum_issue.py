...
def debug_enum_serialization():
    ...
    msg = SmartBotMessage(session_id='test-session', message_type=SmartBotMessageType.QUESTION, content='Test message')
    ...
    msg_dict = {'session_id': msg.session_id, 'message_type': msg.message_type, 'content': msg.content}
